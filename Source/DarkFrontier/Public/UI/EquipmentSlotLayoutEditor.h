...
#include "EquipmentSlotLayoutEditor.generated.h"

/**
 * 
 */
UCLASS(Abstract)
class DARKFRONTIER_API UEquipmentSlotLayoutEditor : public UCommonUserWidget, public IUserObjectListEntry
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<class UStructureEquipmentSlot> EquipmentSlot;
